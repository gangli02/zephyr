.. zephyr:code-sample:: wifi-ble-central-ht-ot
   :name: Wi-Fi Shell, Bluetooth LE Health Thermometer (Central),
      and OpenThread Shell Coexistence
   :relevant-api: bluetooth net_stats

   Demonstrates coexistence of the Wi-Fi shell, Bluetooth LE Central
   role using the Health Thermometer profile, and the OpenThread shell
...
BLE specifically looks for health thermometer sensor and reports the
...
* Bluetooth LE Health Thermometer
...
Build the wifi-ble-central-ht-ot application like this:

.. zephyr-app-commands::
   :zephyr-app: samples/net/wireless/coex/central_ht
   :board: <board to use>
   :goals: build
   :compact:
